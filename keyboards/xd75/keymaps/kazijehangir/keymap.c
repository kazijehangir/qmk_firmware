 ...
 */
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    KC_F13,         KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_PGUP, KC_SPC,  KC_PGDN, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F14, \
    KC_TAB,         KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_BSLS, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT, \
    LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_MINS, KC_GRV,  KC_EQL,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,  \
    KC_LSPO,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME, KC_UP,   KC_END, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
    KC_HYPR,        KC_LGUI, KC_LALT, MO(_FN), KC_DEL,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC, KC_BSPC,  MO(_LED), KC_RALT, KC_RGUI, RCTL_T(KC_ESC)  \
 ),
/* NAV FUNCTIONALITY
 * .--------------------------------------------------------------------------------------------------------------------------------------.
