 ...
 */
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    KC_F13,          KC_1,    KC_2,    KC_3,    KC_4,           KC_5,            KC_PGUP, KC_SPC,  KC_PGDN,     KC_6,           KC_7,             KC_8,     KC_9,     KC_0,     KC_F12, \
    ...
    KC_HYPR,        MO(_FN), KC_LGUI, KC_LALT, KC_DEL,         KC_SPC,          KC_LEFT, KC_DOWN, KC_RGHT,     KC_SPC,         KC_BSPC,          KC_RALT,  KC_RGUI,  MO(_LED), KC_HYPR  \
 ),
/* NAV FUNCTIONALITY
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    _______, _______, _______   , _______   , _______   , KC_MPLY, KC_MPRV, KC_VOLD, KC_MNXT, KC_MPLY, _______, _______, _______,  _______, _______ \
 ),
 ...
 */
 ...
 [_LED] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, RGB_SAD, RGB_SAI, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, _______, _______,   _______, _______, QK_BOOT, \
    KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  RGB_VAD, RGB_VAI, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, _______, _______, _______, \
    _______, MO(_FN), RGB_TOG, _______, RGB_RMOD,RGB_MOD, KC_P0,   _______, KC_PDOT, KC_PENT, KC_PENT, _______, _______, MO(_LED), _______  \
 ),
};
